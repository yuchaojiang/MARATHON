...
devtools::install_github(c("yuchaojiang/CODEX2/package", "zhouzilu/iCNV", "yuchaojiang/MARATHON/package"))
```
...
```{r, message=FALSE, eval = FALSE}
finalcall.codex2.nr <- segment.recursive(Y_qc, Yhat.nr, optK = which.max(BIC.nr),
...
# write.table(finalcall.codex2.nr, file = 'finalcall.codex2.nr.int.txt', 
#             sep='\t', quote=FALSE, row.names=FALSE)
```
