...
gitUrl = "https://github.com/yuchaojiang/Canopy/tree/master/instruction"
source_data(paste0(gitUrl, "/mymatrix.demo.rda?raw=True"))
source_data(paste0(gitUrl, "/genotype.demo.rda?raw=True"))
source_data(paste0(gitUrl, "/reads.demo.rda?raw=True"))
```
